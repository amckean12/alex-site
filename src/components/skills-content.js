...
import { faHtml5, faCss3, faJsSquare, faReact, faNodeJs, faBootstrap, faGit, faGithub } from '@fortawesome/free-brands-svg-icons'
...
const SkillsContent = (props) => (
  <div className="skills-content">
    ...
    <Skill faIcon={<FontAwesomeIcon icon={faBootstrap}/>} skill={"Bootstrap"} describe={"Open-source CSS framework."}/>
    ...
    <Skill faIcon={<FontAwesomeIcon icon={faGithub}/>} skill={"Github"} describe={"A great place to host projects."}/>
  </div>
);
